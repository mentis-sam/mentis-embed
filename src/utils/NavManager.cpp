...
NavScreen colonise_colonising = NavScreen(colonise_colonising_i, colonise_colonising_il, 12, NULL, NULL, &colonise_cancel, []() {MachineState::startState(colonisation, &Settings::lerpSettings.c_timeperiod);}); 
