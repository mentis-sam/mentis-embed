...
NavScreen colonise_colonising = NavScreen(colonise_colonising_i, colonise_colonising_il, 12, NULL, NULL, &menu_colonise, []() {MachineState::startState(colonisation, DateTime(0, 0, c_timeperiod, 0, 0, 0));}); 
...
NavScreen mycelium_fruiting = NavScreen(mycelium_fruiting_i, mycelium_fruiting_il, 12, NULL, NULL, &menu_colonise, []() {MachineState::startState(colonisation, DateTime(0, 0, f_timeperiod, 0, 0, 0));}); 
