...
String host = "mentis-ota-lunchbox.s3.eu-west-2.amazonaws.com"; // Host => bucket-name.s3.region.amazonaws.com
int port = 80; // Non https. For HTTPS 443. As of today, HTTPS doesn't work.
String bin = "/lunchbox-release.bin"; // bin file name with a slash in front.
